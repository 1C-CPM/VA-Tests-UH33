...
Сценарий: 06.01. [КОНКУРС] СПЗ 3
	...
	* Материал1
		...
		И Я добавляю Номенклатуру в ТЧ ="Номенклатура", Номенклатура = "Материал1", ЦФО = "Королевство Севера [223]", МестоПоставки = "МестоПоставки1", ДатаПоставки = "20.08.2026", Колво = "300", Цена = "1 200,00", СтавкаНДС = "22%", Проект = "Проект1"
	...
	* Материал2
		...
		И Я добавляю Номенклатуру в ТЧ ="Номенклатура", Номенклатура = "Материал2", ЦФО = "Королевство Севера [223]", МестоПоставки = "МестоПоставки2", ДатаПоставки = "25.08.2026", Колво = "250", Цена = "1 500,00", СтавкаНДС = "22%", Проект = "Проект1"
		И Я добавляю Статью БДДС в ТЧ "Номенклатура", Статья = "Статья БДДС 1", А1 = "AAA1", А2 = "BBB1", А3 = "CCC1", А4 = "DDD1", А5 = "EEE1", А6 = "FFF1"
		И Я добавляю Статью БДР в ТЧ "Номенклатура", Статья = "Статья БДР 1", А1 = "XXX1", А2 = "YYY1", А3 = "ZZZ1", А4 = "SSS1", А5 = "RRR1", А6 = "WWW1"
...
Сценарий: 06.02. [КОНКУРС] Закупочная процедура 3 / зонтичная
	...
	* Создаем процедуру
		...
		И в таблице "Список" я перехожу к строке:
			...
			| 'RUB'    | 'Королевство Севера [223]' | 'Семь королевств' |'2026 г.'        | 'Приобретение материалов, тест 3' | 'Конкурс'        | 'Утвержден' | '735 000,00' |
...
Сценарий: 06.03. [КОНКУРС] Предложение 1
		...
		И в таблице "Список" я перехожу к строке:
			...
			| 'Семь королевств'     |'Королевство Севера [223]'| '2026 г.'        | 'Приобретение материалов, тест 3' | 'Конкурс'        |'Утвержден' |
		И в таблице "Список" я выбираю текущую строку
		Тогда открылось окно 'Закупочная процедура №*'
		...
		И в таблице "Лоты" я перехожу к строке:
			...
			| '2026 г.'        | 'Зонтичная закупка' | 'Королевство Севера [223]' | 'По конкурентным листам' | 'Приобретение материалов, тест 3' | '735 000,00, RUB' |
...
Сценарий: 06.07. [КОНКУРС] Договор ДД3-1
	...
	* Открываем протокол
		...
		И в таблице 'Список' я перехожу к строке:
			...
			|'Королевство Севера [223]'|'Семь королевств'    |'2026 г.'       |'Конкурс'         |'#3 Победитель определен, кворум имеется'|
