...
Сценарий: 06.06. [КОНКУРС] Протокол #3
	...
	* Результат
		...
		И в поле с именем 'РезультатРаботыКомиссии' я ввожу текст "#3 Победитель определен, кворум имеется"
		И я перехожу к следующему реквизиту
...
Сценарий: 06.07. [КОНКУРС] Договор ДД3-1
	...
	* Открываем протокол
		...
		И в таблице 'Список' я перехожу к строке:
			...
			|'Королевство Севера [223]'|'Семь королевств'    |'2025 г.'       |'Конкурс'         |'#3 Победитель определен, кворум имеется'|
