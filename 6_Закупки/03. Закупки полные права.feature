...
Сценарий: 03.01. Корпоративные закупки (настройки)
	...
	* Настройки группы Планирование потребности

		И я разворачиваю группу с именем 'ГруппаПланированиеПотребности'
...
Сценарий: 03.03. Установка цен номенклатуры "Плановые цены", цена вкл.НДС
	...
	* Дата документа
		...
		И в поле с именем 'Дата' я ввожу текст '01.01.2025 10:00:00'
...
Сценарий: 03.04. Установка цен номенлатуры "Цена поставки НДС сверху"
...
Сценарий: 03.05. Правила закупок
Сценарий: 03.06. Положение о закупках
