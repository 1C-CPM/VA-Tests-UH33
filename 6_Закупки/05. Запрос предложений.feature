...
Сценарий: 05.02. [ЗАПРОС ПРЕДЛОЖЕНИЙ] СПЗ 2
	...
	* Убедимся, что таблица заполнена корректно
		...
		Тогда таблица 'Номенклатура' стала равной:
			...
			| 'Статья БДДС 1' | 'т'                 | 'SSS1'        | 'Материал2'    | '25.03.2025'    | '100,000'    | 'МестоПоставки1' | '1,00000000'  | 'Март 2025 г.'       | '20%'        | '100 000,00'    | '1 300,00'            | '20 000,00' | 'YYY1'        | 'Королевство Севера [223]' | '120 000,00'  | 'RRR1'        | 'Проект1' | 'XXX1'        | 'ZZZ1'        | '1 200,00' | 'WWW1'        | 'Статья БДР 1' |
			| 'Статья БДДС 1' | 'т'                 | 'SSS1'        | 'Материал3'    | '18.05.2025'    | '150,000'    | 'МестоПоставки3' | '1,00000000'  | 'Май 2025 г.'        | '20%'        | '187 500,00'    | '1 500,00'            | '37 500,00' | 'YYY1'        | 'Королевство Севера [223]' | '225 000,00'  | 'RRR1'        | 'Проект1' | 'XXX1'        | 'ZZZ1'        | '1 500,00' | 'WWW1'        | 'Статья БДР 1' |
