...
Сценарий: 05.02. [ЗАПРОС ПРЕДЛОЖЕНИЙ] СПЗ 2
	...
	* Материал2
		...
		И Я добавляю Номенклатуру в ТЧ ="Номенклатура", Номенклатура = "Материал2", ЦФО = "Королевство Севера [223]", МестоПоставки = "МестоПоставки1", ДатаПоставки = "25.03.2025", Колво = "100", Цена = "1 200,00", СтавкаНДС = "22%", Проект = "Проект1"
	...
	* Материал3
		...
		И Я добавляю Номенклатуру в ТЧ ="Номенклатура", Номенклатура = "Материал3", ЦФО = "Королевство Севера [223]", МестоПоставки = "МестоПоставки3", ДатаПоставки = "18.05.2025", Колво = "150", Цена = "1 500,00", СтавкаНДС = "22%", Проект = "Проект1"
		И Я добавляю Статью БДДС в ТЧ "Номенклатура", Статья = "Статья БДДС 1", А1 = "AAA1", А2 = "BBB1", А3 = "CCC1", А4 = "DDD1", А5 = "EEE1", А6 = "FFF1"
		И Я добавляю Статью БДР в ТЧ "Номенклатура", Статья = "Статья БДР 1", А1 = "XXX1", А2 = "YYY1", А3 = "ZZZ1", А4 = "SSS1", А5 = "RRR1", А6 = "WWW1"
	...
	* Убедимся, что таблица заполнена корректно
		...
		Тогда таблица 'Номенклатура' стала равной:
			...
			| 'Статья БДДС 1' | 'т'                 | 'SSS1'        | 'Материал2'    | '25.03.2025'    | '100,000'    | 'МестоПоставки1' | '1,00000000'  | 'Март 2025 г.'       | '22%'        | '100 000,00'    | '1 300,00'            | '20 000,00' | 'YYY1'        | 'Королевство Севера [223]' | '120 000,00'  | 'RRR1'        | 'Проект1' | 'XXX1'        | 'ZZZ1'        | '1 200,00' | 'WWW1'        | 'Статья БДР 1' |
			| 'Статья БДДС 1' | 'т'                 | 'SSS1'        | 'Материал3'    | '18.05.2025'    | '150,000'    | 'МестоПоставки3' | '1,00000000'  | 'Май 2025 г.'        | '22%'        | '187 500,00'    | '1 500,00'            | '37 500,00' | 'YYY1'        | 'Королевство Севера [223]' | '225 000,00'  | 'RRR1'        | 'Проект1' | 'XXX1'        | 'ZZZ1'        | '1 500,00' | 'WWW1'        | 'Статья БДР 1' |
