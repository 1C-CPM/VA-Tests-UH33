...
Сценарий: 05.02. [ЗАПРОС ПРЕДЛОЖЕНИЙ] СПЗ 2
	...
	* Убедимся, что таблица заполнена корректно
		...
		Тогда таблица 'Номенклатура' стала равной:
			...
			| 'Статья БДДС 1' | 'т'                 | 'SSS1'        | 'Материал2'    | '25.03.2026'    | '100,000'    | 'МестоПоставки1' | '1,00000000'  | 'Март 2026 г.'       | '22%'        | '100 000,00'    | '1 300,00'            | '20 000,00' | 'YYY1'        | 'Королевство Севера [223]' | '120 000,00'  | 'RRR1'        | 'Проект1' | 'XXX1'        | 'ZZZ1'        | '1 200,00' | 'WWW1'        | 'Статья БДР 1' |
			| 'Статья БДДС 1' | 'т'                 | 'SSS1'        | 'Материал3'    | '18.05.2026'    | '150,000'    | 'МестоПоставки3' | '1,00000000'  | 'Май 2026 г.'        | '22%'        | '187 500,00'    | '1 500,00'            | '37 500,00' | 'YYY1'        | 'Королевство Севера [223]' | '225 000,00'  | 'RRR1'        | 'Проект1' | 'XXX1'        | 'ZZZ1'        | '1 500,00' | 'WWW1'        | 'Статья БДР 1' |
...
Сценарий: 05.05. [ЗАПРОС ПРЕДЛОЖЕНИЙ] Закупочная процедура 2 / попозиционная
	...
	* Создаем процедуру
		...
		И в таблице "Список" я перехожу к строке:
			...
			| 'RUB'    | 'Королевство Севера [223]' | 'Семь королевств' |'2026 г.'        | 'Приобретение материалов, тест 2' | 'Утвержден' | 'Запрос предложений' | 'Утвержден' | '345 000,00' |
