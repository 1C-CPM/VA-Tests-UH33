...
Сценарий: 10.06. [Тест1] Договор ДД9
	...
	* Создаем договор
		...
		Тогда таблица 'Номенклатура' стала равной:
			...
			| 'Товар1'       | 'кг'                | '100,000'    | '1,00000000'  | '20%'        | '7 266,03' | '605 502,15'    | '121 100,43' | '726 602,58' |  'КАЗАХСТАН'            | 'КАЗАХСТАН'            | 'Статья БДДС 1' |'Статья БДР 1' | 'МестоПоставки1' | 'ЦФО1 Королевство Островов и Рек' |
...
Сценарий: 10.07. [Тест1] Заказ поставщику
	...
	* Договор
		...
		И в таблице 'Список' я перехожу к строке:
			...
			| "RUB"    | "С поставщиком" | "ДД9"            | "Королевство Островов и Рек" | "726 602,58" |
		И в таблице 'Список' я выбираю текущую строку
		Тогда открылось окно "Заказ поставщику (создание) *"
...
Сценарий: 10.08. [Тест1] ПТУ
	...
	* Договор
		...
		И в таблице 'Список' я перехожу к строке:
			| "Валюта" | "Вид договора"  | "Номер договора" | "Организация"                | "Сумма"      |
			| "RUB"    | "С поставщиком" | "ДД9"            | "Королевство Островов и Рек" | "157 611,05" |
		И в таблице 'Список' я выбираю текущую строку
		Тогда открылось окно "Заказ поставщику (создание) *"
	...
	* Заказ поставщика
		...
		Тогда таблица 'Товары' стала равной:
			| 'Номенклатура' | 'Количество' | 'Всего'      | 'Единица' | 'Цена'     | 'Сумма'       | 'НДС'        | 'Статьи бюджета и аналитики'                  | 'Страна производителя' | 'Страна происхождения' |
			| 'Товар1'       | '100,000'    | '726 603,00' | 'кг'      | '7 266,03' |  '605 502,50' | '121 100,50' | 'Статья БДР 1;XXX1;YYY1;ZZZ1;SSS1;RRR1;WWW1'  | 'КАЗАХСТАН'            | 'КАЗАХСТАН'            |
