...
Сценарий: 04.01. [ЗАПРОС КОТИРОВОК] СПЗ 1
	...
	* 2025
		...
		* Аналитика1
			...
			И я перехожу к следующему реквизиту
			И в таблице 'Номенклатура' я активизирую поле с именем 'НоменклатураПланыДокументаАналитика1'
			И в таблице 'Номенклатура' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитика1'
		...
		* Аналитика2
			...
			И в таблице "Номенклатура" я перехожу к следующей ячейке
			И в таблице 'Номенклатура' я активизирую поле с именем 'НоменклатураПланыДокументаАналитика2'
			И в таблице 'Номенклатура' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитика2'
			Тогда открылось окно "Произвольный классификатор"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование" |
				| "BBB1"         |
		...
		* Аналитика3
			...
			И в таблице "Номенклатура" я перехожу к следующей ячейке
			И в таблице 'Номенклатура' я активизирую поле с именем 'НоменклатураПланыДокументаАналитика3'
			И в таблице 'Номенклатура' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитика3'
			Тогда открылось окно "Произвольный классификатор"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование" |
				| "CCC1"         |
		...
		* Аналитика4
			...
			И в таблице "Номенклатура" я перехожу к следующей ячейке
			И в таблице 'Номенклатура' я активизирую поле с именем 'НоменклатураПланыДокументаАналитика4'
			И в таблице 'Номенклатура' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитика4'
			Тогда открылось окно "Произвольный классификатор"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование" |
				| "DDD1"         |
		...
		* Аналитика5
			...
			И в таблице "Номенклатура" я перехожу к следующей ячейке
			И в таблице 'Номенклатура' я активизирую поле с именем 'НоменклатураПланыДокументаАналитика5'
			И в таблице 'Номенклатура' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитика5'
			Тогда открылось окно "Произвольный классификатор"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование" |
				| "EEE1"         |
		...
		* Аналитика6
			...
			И в таблице "Номенклатура" я перехожу к следующей ячейке
			И в таблице 'Номенклатура' я активизирую поле с именем 'НоменклатураПланыДокументаАналитика6'
			И в таблице 'Номенклатура' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитика6'
			Тогда открылось окно "Произвольный классификатор"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование" |
				| "FFF1"         |
		...
		* Аналитика2 
			...
			И в таблице "Номенклатура" я перехожу к следующей ячейке
			И в таблице 'Номенклатура' я активизирую поле с именем 'НоменклатураПланыДокументаАналитикаБДР2'
			И в таблице 'Номенклатура' я выбираю текущую строку
			И в таблице 'Номенклатура' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитикаБДР2'
			Тогда открылось окно "Произвольный классификатор"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование" |
				| "YYY1"         |
		...
		* Аналитика3 
			...
			И в таблице "Номенклатура" я перехожу к следующей ячейке
			И в таблице 'Номенклатура' я активизирую поле с именем 'НоменклатураПланыДокументаАналитикаБДР3'
			И в таблице 'Номенклатура' я выбираю текущую строку
			И в таблице 'Номенклатура' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитикаБДР3'
			Тогда открылось окно "Произвольный классификатор"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование" |
				| "ZZZ1"         |
		...
		* Аналитика4 
			...
			И в таблице "Номенклатура" я перехожу к следующей ячейке
			И в таблице 'Номенклатура' я активизирую поле с именем 'НоменклатураПланыДокументаАналитикаБДР4'
			И в таблице 'Номенклатура' я выбираю текущую строку
			И в таблице 'Номенклатура' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитикаБДР4'
			Тогда открылось окно "Произвольный классификатор"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование" |
				| "SSS1"         |
		...
		* Аналитика5 
			...
			И в таблице "Номенклатура" я перехожу к следующей ячейке
			И в таблице 'Номенклатура' я активизирую поле с именем 'НоменклатураПланыДокументаАналитикаБДР5'
			И в таблице 'Номенклатура' я выбираю текущую строку
			И в таблице 'Номенклатура' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитикаБДР5'
			Тогда открылось окно "Произвольный классификатор"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование" |
				| "RRR1"         |
		...
		* Аналитика6 
			...
			И в таблице "Номенклатура" я перехожу к следующей ячейке
			И в таблице 'Номенклатура' я активизирую поле с именем 'НоменклатураПланыДокументаАналитикаБДР6'
			И в таблице 'Номенклатура' я выбираю текущую строку
			И в таблице 'Номенклатура' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитикаБДР6'
			Тогда открылось окно "Произвольный классификатор"
			И в таблице 'Список' я перехожу к строке:
				| "Наименование" |
				| "WWW1"         |
...
//			| 'Статья БДДС 1' | 'т'                 | 'SSS1'        | 'Королевство Севера [223]' | 'Материал2'    | '25.03.2025'    | '100,000'    | 'МестоПоставки1' | '1,00000000'  | 'Март 2025 г.'       | '20%'        | 'RRR1'        | 'Проект1' | 'XXX1'        | 'YYY1'        | 'ZZZ1'        | '1 200,00' | 'WWW1'        | 'Статья БДР 1' |
//
//		И я заполняю таблицу "Номенклатура" данными
...
//		И я закрываю все окна клиентского приложения
//
Сценарий: 04.09. [КОНКУРС] Протокол и договор ДД3 по закупочной процедуре 3
//
//	* Запоминаем текущую дату
//		
//		И Я запоминаю значение выражения 'СокрЛП(ТекущаяДата())' в переменную "ТекущаяДата"	
...
//		И я закрываю все окна клиентского приложения
//	
Сценарий: 04.10. [ЗАПРОС КОТИРОВОК] ПТУ по договору ДД1
//
//	* Запоминаем текущую дату
//		
//		И Я запоминаю значение выражения 'СокрЛП(ТекущаяДата())' в переменную "ТекущаяДата"
...
//		И я закрываю все окна клиентского приложения			
//		
Сценарий: 04.12. [КОНКУРС] ПТУ по договору ДД3-1 (поставщик: Поставщик4)
//
//	* Запоминаем текущую дату
//		
//		И Я запоминаю значение выражения 'СокрЛП(ТекущаяДата())' в переменную "ТекущаяДата"
...
//		И я закрываю все окна клиентского приложения					
//		
Сценарий: 04.13. [КОНКУРС] ПТУ по договору ДД3-2 (поставщик: Поставщик5)
//
//	* Запоминаем текущую дату
//		
//		И Я запоминаю значение выражения 'СокрЛП(ТекущаяДата())' в переменную "ТекущаяДата"
...
//		И я закрываю все окна клиентского приложения							
//	
Сценарий: 04.15. [ЗАЯВКА -> ЗАКАЗ; Королевство Скал] Заявка на обеспечение
...
Сценарий: 04.16. [ЗАЯВКА -> ЗАКАЗ; Королевство Скал] Договор ДД4
//
...
//		И я закрываю все окна клиентского приложения
//		
Сценарий: 04.17. [ЗАЯВКА -> ЗАКАЗ; Королевство Скал] Заказ поставщику
//
...
//		И я закрыл все окна клиентского приложения	
//		
Сценарий: 04.18. [ЗАЯВКА -> ЗАКАЗ; Королевство Скал] ПТУ
//
...
//		И я закрыл все окна клиентского приложения
//		
Сценарий: 04.19. [ЗАЯВКА -> ЗАКАЗ; Королевство Скал] Возврат поставщику
//
...
//		И я закрыл все окна клиентского приложения
//
Сценарий: 04.20. [ЗАЯВКА -> СПЗ; Королевство Дорна] Заявка на обеспечение 
//
...
//
Сценарий: 04.21. [ЗАЯВКА -> СПЗ; Королевство Дорна] СПЗ
//
...
//		И я жду закрытия окна 'Строка плана закупок * от *' в течение 20 секунд
//
Сценарий: 02.22. [ЗАЯВКА -> ЛОТ;  Королевство простора] Заявка на обеспечение
//
//	* Запоминаем текущую дату + 30 дней
//		
//		И Я запоминаю значение выражения 'СокрЛП(ТекущаяДата()+30*24*60*60)' в переменную "ТекущаяДата30"
...
//		И Я закрываю окно 'Заявка на обеспечение'
//		
Сценарий: 04.23. [ЗАЯВКА -> ЛОТ;  Королевство простора] Закупочная процедура 
//
//	* Запоминаем текущую дату
//		
//		И Я запоминаю значение выражения 'СокрЛП(ТекущаяДата())' в переменную "ТекущаяДата"	
...
//		И я закрыл все окна клиентского приложения
//		
Сценарий: 04.24. [ЗАЯВКА -> ДОГОВОР] Заявка на обеспечение Королевство Гор и Долин
//
//	* Запоминаем текущую дату + 30 дней
//		
//		И Я запоминаю значение выражения 'СокрЛП(ТекущаяДата()+30*24*60*60)' в переменную "ТекущаяДата30"
...
//		И Я закрываю окно 'Заявка на обеспечение'
//		
Сценарий: 04.25. [ЗАЯВКА -> ДОГОВОР] Договор ДД5 Королевство Гор и Долин
//
