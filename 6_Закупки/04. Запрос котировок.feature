...
Сценарий: 04.02. [ЗАПРОС КОТИРОВОК] Закупочная процедура 1 / лотовая
	...
	* Создаем процедуру
		...
		И в таблице "Список" я перехожу к строке:
			...
			|'2025 г.'       | 'Королевство Севера [223]' | 'Семь королевств' | 'Запрос котировок' | 'Приобретение материалов, тест 1' | 'Утвержден' | '120 000,00' |  'RUB'  | 'Утвержден' |
	...
	* Предложение участника 1
		...
		// тут остановился критерии по номенклатуре не заполняет
