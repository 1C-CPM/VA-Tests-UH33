...
Сценарий: 11.01. [ЗАПРОС КОТИРОВОК] СПЗ 1
	...
	* Закладка Потребности
		...
		* Номенклатура1
		...
		И Я добавляю Номенклатуру в ТЧ ="Номенклатура", Номенклатура = "Материал2", ЦФО = "Королевство Севера [223]", МестоПоставки = "МестоПоставки1", ДатаПоставки = "15.08.2025", Колво = "100", Цена = "1 200,00", СтавкаНДС = "22%", Проект = "Проект1"
	...
	* Номенклатура2
		...
		И Я добавляю Номенклатуру в ТЧ ="Номенклатура", Номенклатура = "Материал3", ЦФО = "Королевство Севера [223]", МестоПоставки = "МестоПоставки3", ДатаПоставки = "20.05.2025", Колво = "150", Цена = "1 500,00", СтавкаНДС = "22%", Проект = "Проект1"
		И Я добавляю Статью БДДС в ТЧ "Номенклатура", Статья = "Статья БДДС 1", А1 = "AAA1", А2 = "BBB1", А3 = "CCC1", А4 = "DDD1", А5 = "EEE1", А6 = "FFF1"
		И Я добавляю Статью БДР в ТЧ "Номенклатура", Статья = "Статья БДР 1", А1 = "XXX1", А2 = "YYY1", А3 = "ZZZ1", А4 = "SSS1", А5 = "RRR1", А6 = "WWW1"
...
Сценарий: 11.06. [ЗАПРОС КОТИРОВОК] Договор ДД6
	...
	* Контроль графика поставок
		...
		Тогда таблица 'Номенклатура' стала равной:
			...
			| 'Материал2'    | 'Королевство Севера [223]' | 'МестоПоставки1' | '100,000'    | 'т'                 | '800,00'   | 'РОССИЯ'               | '1,00000000'  | '15.08.2025'    | '22%'        | '80 000,00'     | '96 000,00'   | 'Проект1' | '16 000,00' | 'РОССИЯ'               |
			| 'Материал3'    | 'Королевство Севера [223]' | 'МестоПоставки3' | '150,000'    | 'т'                 | '1 400,00' | 'РОССИЯ'               | '1,00000000'  | '20.05.2025'    | '22%'        | '210 000,00'    | '252 000,00'  | 'Проект1' | '42 000,00' | 'РОССИЯ'               |
