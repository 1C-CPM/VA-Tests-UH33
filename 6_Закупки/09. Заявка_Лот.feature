...
Сценарий: 09.02. [ЗАЯВКА -> ЛОТ;  Королевство простора] Закупочная процедура 
	...
	* Проверяем подобранные товары 
		...
		Тогда таблица 'Номенклатура' стала равной:
			...
			| 'Товар1'       | '10 000,00' | 'кг'                | '29.06.2025'     | 'ЦФО1 Королевство Простора' | '100,000'    | 'МестоПоставки1' | '833 333,33'    | '22%'        | '166 666,67' | '1 000 000,00' | 'Статья БДДС 1' | 'Статья БДР 1' |
			| 'Товар2'       | '8 500,00'  | 'Упак'              | '29.06.2025'     | 'ЦФО1 Королевство Простора' | '100,000'    | 'МестоПоставки1' | '708 333,33'    | '22%'        | '141 666,67' | '850 000,00'   | 'Статья БДДС 1' | 'Статья БДР 1' |
