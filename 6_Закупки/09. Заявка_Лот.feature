...
Сценарий: 09.02. [ЗАЯВКА -> ЛОТ;  Королевство простора] Закупочная процедура 
	...
	* Проверяем подобранные товары 
		...
		Тогда таблица 'Номенклатура' стала равной:
			...
			| 'Товар1'       | '10 000,00' | 'кг'                | '29.06.2026'     | 'ЦФО1 Королевство Простора' | '100,000'    | 'МестоПоставки1' | '819 672,13'    | '22%'        | '180 327,87' | '1 000 000,00' | 'Статья БДДС 1' | 'Статья БДР 1' |
			| 'Товар2'       | '8 500,00'  | 'Упак'              | '29.06.2026'     | 'ЦФО1 Королевство Простора' | '100,000'    | 'МестоПоставки1' | '696 721,31'    | '22%'        | '153 278,69' | '850 000,00'   | 'Статья БДДС 1' | 'Статья БДР 1' |
