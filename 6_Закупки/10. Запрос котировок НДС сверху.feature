...
Сценарий: 10.06. [ЗАПРОС КОТИРОВОК] Договор ДД6
	...
	* Открываем протокол
		...
		И в таблице 'Список' я перехожу к строке:
			...
			|'Королевство Севера [223]'|'Семь королевств'    |'2025 г.'       |'Запрос котировок' |'#4 Победитель определен, кворум имеется'|
	...
	* Контроль графика поставок
		...
		Тогда таблица 'Номенклатура' стала равной:
			| 'Номенклатура' | 'Потребитель (ЦФО)'        | 'Место поставки' | 'Количество' | 'Единица измерения' | 'Цена'     | 'Страна производителя' | 'Коэффициент' | 'Дата поставки' | 'Ставка НДС' | 'Сумма без НДС' | 'Сумма с НДС' | 'Проект'  | 'Сумма НДС' | 'Страны происхождения' |
			| 'Материал2'    | 'Королевство Севера [223]' | 'МестоПоставки1' | '100,000'    | 'т'                 | '800,00'   | 'РОССИЯ'               | '1,00000000'  | '15.08.2025'    | '20%'        | '80 000,00'     | '96 000,00'   | 'Проект1' | '16 000,00' | 'РОССИЯ'               |
			| 'Материал3'    | 'Королевство Севера [223]' | 'МестоПоставки3' | '150,000'    | 'т'                 | '1 400,00' | 'РОССИЯ'               | '1,00000000'  | '20.05.2025'    | '20%'        | '210 000,00'    | '252 000,00'  | 'Проект1' | '42 000,00' | 'РОССИЯ'               |
...
Сценарий: 10.07. [ЗАПРОС КОТИРОВОК] ПТУ по договору ДД6
	...
	* Проверяем правильность заполнения строки
		...
		Тогда таблица "Товары" стала равной:
			...
			| 'Материал2'    | '20%'   | '100,000'    | 'т'       | '800,00'   | '16 000,00' | 'РОССИЯ'                | '80 000,00'  | '96 000,00'  |
			| 'Материал3'    | '20%'   | '150,000'    | 'т'       | '1 400,00' | '42 000,00' | 'РОССИЯ'                | '210 000,00' | '252 000,00' |
