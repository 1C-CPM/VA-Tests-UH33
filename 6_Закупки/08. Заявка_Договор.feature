...
Сценарий: 08.01. [ЗАЯВКА -> ДОГОВОР] Заявка на обеспечение Королевство Гор и Долин
	...
	* Дата поставки	
		...
		И в поле с именем 'ДатаОперации' я ввожу текст "22.07.2026"
...
Сценарий: 08.02. [ЗАЯВКА -> ДОГОВОР] Договор ДД5 Королевство Гор и Долин
	...
	* Срок действия договора
		...
		И в поле с именем 'НачалоДействия' я ввожу текст '01.01.2026'
		И я перехожу к следующему реквизиту
	...
	* Проверяем подобранные данные
		...
		Тогда таблица 'Номенклатура' стала равной:
				...
				| '25 000,00' | 'шт'                |  'Товар5'       | '22,000'     | 'МестоПоставки2' | '22.07.2026'    | 'ЦФО2 Королевство Скал' | '22%'        | '458 333,33'    | '91 666,67' | '550 000,00'  | 'Проект2' | 'Статья БДДС 1' | 'Статья БДР 1' |
...
//		И в таблице 'Номенклатура' я выбираю текущую строку
		И в таблице 'Номенклатура' в поле с именем 'НоменклатураДатаПоставки' я ввожу текст "31.07.2026"
		И я перехожу к следующему реквизиту
//		И в таблице 'Номенклатура' я завершаю редактирование строки
