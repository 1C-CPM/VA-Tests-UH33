...
Сценарий: Открытие формы отчета "Анализ обеспечения потребности" (АнализПотребностей)

	Дано Я открываю основную форму отчета "АнализПотребностей"
	Если появилось предупреждение Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму отчета АнализПотребностей"
	Если имя текущей формы "ErrorWindow" Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму отчета АнализПотребностей"
	И Я закрываю текущее окно
...
Сценарий: Открытие формы отчета "Задолженность покупателей" (ЗадолженностьПокупателей)
