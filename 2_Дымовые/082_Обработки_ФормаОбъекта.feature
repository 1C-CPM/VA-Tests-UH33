...
Сценарий: Открытие формы обработки "Проверка правил заполнения и отбора аналитик" (ПроверкаКорректностиОписанияМетаданных)
...
Сценарий: Открытие формы обработки "Соответствие контрагентов и банковских счетов для операций РКО" (УправлениеСоответствиемБанковИКонтрагентов)
