...
Сценарий: Я добавляю Статью БДДС в ТЧ "ТекТЧ", Статья = "ТекСтатья", А1 = "ТекА1", А2 = "ТекА2", А3 = "ТекА3", А4 = "ТекА4", А5 = "ТекА5", А6 = "ТекА6"
	...
	* Статья БДДС
		...
		* Аналитика1
		...
		И я перехожу к следующему реквизиту
		И в таблице '[ТекТЧ]' я активизирую поле с именем 'НоменклатураПланыДокументаАналитика1'
		И в таблице '[ТекТЧ]' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитика1'
		Тогда открылось окно "Произвольный классификатор"
		И в таблице 'Список' я перехожу к строке:
			| "Наименование" |
			| "[ТекA1]"      |
		...
		* Аналитика2
		...
		И в таблице '[ТекТЧ]' я активизирую поле с именем 'НоменклатураПланыДокументаАналитика2'
		И в таблице '[ТекТЧ]' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитика2'
		Тогда открылось окно "Произвольный классификатор"
		И в таблице 'Список' я перехожу к строке:
			| "Наименование" |
			| "[ТекA2]"      |
		...
		* Аналитика3
		...
		И в таблице "[ТекТЧ]" я перехожу к следующей ячейке
		И в таблице '[ТекТЧ]' я активизирую поле с именем 'НоменклатураПланыДокументаАналитика3'
		И в таблице '[ТекТЧ]' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитика3'
		Тогда открылось окно "Произвольный классификатор"
		И в таблице 'Список' я перехожу к строке:
			| "Наименование" |
			| "[ТекA3]"      |
		...
		* Аналитика4
		...
		И в таблице "[ТекТЧ]" я перехожу к следующей ячейке
		И в таблице '[ТекТЧ]' я активизирую поле с именем 'НоменклатураПланыДокументаАналитика4'
		И в таблице '[ТекТЧ]' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитика4'
		Тогда открылось окно "Произвольный классификатор"
		И в таблице 'Список' я перехожу к строке:
			| "Наименование" |
			| "[ТекA4]"      |
		...
		* Аналитика5
		...
		И в таблице "[ТекТЧ]" я перехожу к следующей ячейке
		И в таблице '[ТекТЧ]' я активизирую поле с именем 'НоменклатураПланыДокументаАналитика5'
		И в таблице '[ТекТЧ]' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитика5'
		Тогда открылось окно "Произвольный классификатор"
		И в таблице 'Список' я перехожу к строке:
			| "Наименование" |
			| "[ТекA5]"      |
		...
		* Аналитика6
		...
		И в таблице "[ТекТЧ]" я перехожу к следующей ячейке
		И в таблице '[ТекТЧ]' я активизирую поле с именем 'НоменклатураПланыДокументаАналитика6'
		И в таблице '[ТекТЧ]' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитика6'
		Тогда открылось окно "Произвольный классификатор"
		И в таблице 'Список' я перехожу к строке:
			| "Наименование" |
			| "[ТекA6]"      |
...
Сценарий: Я добавляю Статью БДР в ТЧ "ТекНоменклатура", Статья = "ТекСтатья 1", А1 = "ТекА1", А2 = "ТекА2", А3 = "ТекА3", А4 = "ТекА4", А5 = "ТекА5", А6 = "ТекА6"
		...
		* Аналитика1 
		...
		И в таблице '[ТекТЧ]' я активизирую поле с именем 'НоменклатураПланыДокументаАналитикаБДР1'
		И в таблице '[ТекТЧ]' я выбираю текущую строку
		И в таблице '[ТекТЧ]' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитикаБДР1'
		Тогда открылось окно "Произвольный классификатор"
		И в таблице 'Список' я перехожу к строке:
			| "Наименование" |
			| "[ТекA1]"      |
		...
		* Аналитика2 
		...
		И в таблице '[ТекТЧ]' я перехожу к следующей ячейке
		И в таблице '[ТекТЧ]' я активизирую поле с именем 'НоменклатураПланыДокументаАналитикаБДР2'
		И в таблице '[ТекТЧ]' я выбираю текущую строку
		И в таблице '[ТекТЧ]' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитикаБДР2'
		Тогда открылось окно "Произвольный классификатор"
		И в таблице 'Список' я перехожу к строке:
			| "Наименование" |
			| "[ТекA2]"      |
		...
		* Аналитика3 
		...
		И в таблице '[ТекТЧ]' я перехожу к следующей ячейке
		И в таблице '[ТекТЧ]' я активизирую поле с именем 'НоменклатураПланыДокументаАналитикаБДР3'
		И в таблице '[ТекТЧ]' я выбираю текущую строку
		И в таблице '[ТекТЧ]' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитикаБДР3'
		Тогда открылось окно "Произвольный классификатор"
		И в таблице 'Список' я перехожу к строке:
			| "Наименование" |
			| "[ТекA3]"      |
		...
		* Аналитика4 
		...
		И в таблице '[ТекТЧ]' я перехожу к следующей ячейке
		И в таблице '[ТекТЧ]' я активизирую поле с именем 'НоменклатураПланыДокументаАналитикаБДР4'
		И в таблице '[ТекТЧ]' я выбираю текущую строку
		И в таблице '[ТекТЧ]' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитикаБДР4'
		Тогда открылось окно "Произвольный классификатор"
		И в таблице 'Список' я перехожу к строке:
			| "Наименование" |
			| "[ТекA4]"      |
		...
		* Аналитика5 
		...
		И в таблице '[ТекТЧ]' я перехожу к следующей ячейке
		И в таблице '[ТекТЧ]' я активизирую поле с именем 'НоменклатураПланыДокументаАналитикаБДР5'
		И в таблице '[ТекТЧ]' я выбираю текущую строку
		И в таблице '[ТекТЧ]' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитикаБДР5'
		Тогда открылось окно "Произвольный классификатор"
		И в таблице 'Список' я перехожу к строке:
			| "Наименование" |
			| "[ТекA5]"      |
		...
		* Аналитика6 
		...
		И в таблице '[ТекТЧ]' я перехожу к следующей ячейке
		И в таблице '[ТекТЧ]' я активизирую поле с именем 'НоменклатураПланыДокументаАналитикаБДР6'
		И в таблице '[ТекТЧ]' я выбираю текущую строку
		И в таблице '[ТекТЧ]' я нажимаю кнопку выбора у реквизита с именем 'НоменклатураПланыДокументаАналитикаБДР6'
		Тогда открылось окно "Произвольный классификатор"
		И в таблице 'Список' я перехожу к строке:
			| "Наименование" |
			| "[ТекA6]"      |
