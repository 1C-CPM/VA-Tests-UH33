...
Сценарий: 05.2. Оплата платежных поручений
	...
	* Оплата поставщику, 0000-000001
		...
		И в таблице "Список" я перехожу к строке:
			| 'Вид операции'      | 'Организация'             | 'Получатель' | 'Состояние'    |
			| 'Оплата поставщику' | 'Королевство Гор и Долин' | 'Поставщик1' | 'Подготовлено' |
	...
	* Возврат покупателю, 0000-000002
		...
		И в таблице "Список" я перехожу к строке:
			| 'Вид операции'       | 'Организация'             | 'Получатель'  | 'Состояние'    |
			| 'Возврат покупателю' | 'Королевство Гор и Долин' | 'Покупатель1' | 'Подготовлено' |
		И в таблице "Список" я выбираю текущую строку
		Тогда открылось окно 'Платежное поручение * от *'
	...
	* Уплата налога, 0000-000003
		...
		И в таблице "Список" я перехожу к строке:
			| 'Вид операции'  | 'Организация'             | 'Получатель'                         | 'Состояние'    |
			| 'Уплата налога' | 'Королевство Гор и Долин' | 'МИ ФНС России по управлению долгом' | 'Подготовлено' |
		И в таблице "Список" я выбираю текущую строку
		Тогда открылось окно 'Платежное поручение * от *'
	...
	* Возврат займа контрагенту, 0000-000004
		...
		И в таблице "Список" я перехожу к строке:
			| 'Вид операции'              | 'Организация'             | 'Получатель'  | 'Состояние'    |
			| 'Возврат займа контрагенту' | 'Королевство Гор и Долин' | 'Контрагент1' | 'Подготовлено' |
		И в таблице "Список" я выбираю текущую строку
		Тогда открылось окно 'Платежное поручение * от *'
	...
	* Возврат кредита банку, 0000-000005 
		...
		И в таблице "Список" я перехожу к строке:
			| 'Вид операции'          | 'Организация'             | 'Получатель' | 'Состояние'    |
			| 'Возврат кредита банку' | 'Королевство Гор и Долин' | 'Банк1'      | 'Подготовлено' |
		И в таблице "Список" я выбираю текущую строку
		Тогда открылось окно 'Платежное поручение * от *'
	...
	* Прочие расчеты с контрагентами, 0000-000006 
		...
		И в таблице "Список" я перехожу к строке:
			| 'Вид операции'               | 'Организация'             | 'Получатель'  | 'Состояние'    |
			| 'Прочие платежи контрагенту' | 'Королевство Гор и Долин' | 'Контрагент1' | 'Подготовлено' |
		И в таблице "Список" я выбираю текущую строку
		Тогда открылось окно 'Платежное поручение * от *'
