...
Сценарий: 01.03 Создание БС Организации
	...
	* Создание элемента
		...
		Если '$$ЭтоЕРПУХ$$' Тогда
			...
			И в таблице "Список" я нажимаю на кнопку с именем 'СоздатьБанковскийСчет'
			Тогда открылось окно 'Банковский счет организации (создание)'
			И в поле с именем 'НомерСчета' я ввожу текст '40700810000000000011'
			И из выпадающего списка с именем "Банк" я выбираю по строке '044525630'
			И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
...
Сценарий: 01.10 Организационная структура
	...
	* Создаем ЦФО	
		...
		И Я создаю организацию с именем 'ВА - ЦФО 6 (вне контроля)' типом 'ВыбратьЦФО' видом '' налогооблажением ''
		И Я для организации 'ВА - ЦФО 6 (вне контроля)' для реквизита 'Родитель' выбираю значение 'ВА - ООО Тест' 
