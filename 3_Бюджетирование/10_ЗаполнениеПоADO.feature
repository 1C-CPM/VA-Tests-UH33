...
Сценарий: 10.02 Настройка информационных баз
	...
	* Включение управления НСИ
		И В командном интерфейсе я выбираю "Общие справочники и настройки" "Управление НСИ"
		Тогда открылось окно "Управление нормативно - справочной информацией*"
		И я устанавливаю флаг с именем 'ИспользоватьУправлениеНСИ'
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна "Управление нормативно - справочной информацией*" в течение 20 секунд
	...
	Тогда открылось окно "ВА - Импорт ADO (Excel) (Тип информационной базы)"
	И я перехожу к закладке с именем 'СтраницаADO'
	И в таблице 'ТаблицыADO' я нажимаю на кнопку с именем 'ОбновитьСписокТаблиц'
	Когда открылось окно "ВА - Импорт ADO (Excel) (Тип информационной базы)"
	И я перехожу к закладке с именем 'НастройкиСоответствия'
	
	* Номенклатура
		И я нажимаю на кнопку с именем 'СоответствиеВнешнимИБСоздать'
	...
	* Корневой каталог
	...
	И я перехожу к закладке с именем 'СтраницаADO'
	И в таблице 'ТаблицыADO' я нажимаю на кнопку с именем 'ТаблицыADOПросмотрДанных'
	Тогда открылось окно "Просмотр данных таблицы ADO"
	И Я закрываю окно "Просмотр данных таблицы ADO"
	Тогда открылось окно "ВА - Импорт ADO (Excel) (Тип информационной базы)"
