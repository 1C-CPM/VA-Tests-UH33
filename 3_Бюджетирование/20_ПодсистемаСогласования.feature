...
Сценарий: 20.11 Создание шаблона процесса "ВА - Переход по выбору"
	...
	* Удаляем существующие шаблоны
		И В командном интерфейсе я выбираю "Процессы и согласование" "Шаблоны процессов"
		Тогда открылось окно "Шаблоны универсальных процессов"
		И Я в списке "Шаблоны универсальных процессов" по полю "Наименование" ищу элемент "ВА - Переход по выбору" "По точному совпадению"
		И пока в таблице 'Список' количество строк ">" 0 Тогда
			И в таблице 'Список' я выбираю текущую строку
			Тогда открылось окно "Редактирование этапов процесса: ВА - Переход по выбору"
			И я нажимаю на кнопку с именем 'ФормаОткрытьСвойстваПроцесса'
			Тогда открылось окно "ВА - Переход по выбору (Шаблон универсального процесса)"
			И Я запоминаю значение выражения '"ВА - (удалить) " + StrReplace(Новый УникальныйИдентификатор, "-", "")' в переменную 'UID_Description'
			И в поле с именем 'Наименование' я ввожу значение переменной 'UID_Description'
			И я нажимаю на кнопку с именем 'ФормаЗаписать'
			Тогда открылось окно "$UID_Description$ (Шаблон универсального процесса)"
			...
			И я жду закрытия окна "$UID_Description$ (Шаблон универсального процесса)" в течение 20 секунд
			Тогда открылось окно "Редактирование этапов процесса: ВА - Переход по выбору"
			И Я закрываю окно "Редактирование этапов процесса: ВА - Переход по выбору"

	* Создаем шаблон
		Тогда открылось окно "Шаблоны универсальных процессов"
		И я нажимаю на кнопку с именем 'ФормаСоздать'
		Тогда открылось окно "Шаблон универсального процесса (создание)"
		И в поле с именем 'Наименование' я ввожу текст "ВА - Переход по выбору"
		И из выпадающего списка с именем 'Родитель' я выбираю по строке "ВА - Группа процесса согласования"
		И из выпадающего списка с именем 'НазначениеПроцесса' я выбираю точное значение "Маршрут согласования"
		И из выпадающего списка с именем 'ИмяСправочника' я выбираю точное значение "Документ текущей ИБ"
		И я нажимаю кнопку выбора у поля с именем 'ТипОбъектаСогласования'
	...
	* Этап "Объект утвержден"
		...
		И я нажимаю на кнопку с именем 'ДобавитьВыбранныйЭтап'
		Тогда открылось окно "Автоматическое утверждение документа (Этап универсального процесса)"
		И в поле с именем 'Наименование' я ввожу текст "Авто 1"
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
	...
	* Этап "Переход по выбору"
		...
		И в поле с именем 'Наименование' я ввожу текст "Выбор 1"
		...
		И в таблице 'Утверждающие2' я выбираю текущую строку
		И Я в списке "Пользователи" по полю "Полное имя" ищу и выбираю элемент "Администратор" "По точному совпадению"
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна "* (Этап универсального процесса)*" в течение 20 секунд
	...
	* Этап "Оповещение" 1
		...
		И в поле с именем 'Наименование' я ввожу текст "Опов 1"
		...
		И в поле с именем 'ШаблонОповещения' я ввожу текст "Оповещение после перехода по выбору 1"
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна "* (Этап универсального процесса)*" в течение 20 секунд
	...
	* Этап "Оповещение" 2
		...
		И я нажимаю на кнопку с именем 'ДобавитьВыбранныйЭтап'
		Тогда открылось окно "Оповещение (Этап универсального процесса)"
		И в поле с именем 'Наименование' я ввожу текст "Опов 2"
		И в таблице 'Адресаты' я активизирую поле с именем 'АдресатыСпособАдресации'
		И в таблице 'Адресаты' я выбираю текущую строку
		И в таблице 'Адресаты' из выпадающего списка с именем 'АдресатыСпособАдресации' я выбираю точное значение "Пользователь"
		И в таблице 'Адресаты' я завершаю редактирование строки
		...
		И Я в списке "Пользователи" по полю "Полное имя" ищу и выбираю элемент "Администратор" "По точному совпадению"
		И я перехожу к закладке "Редактирование шаблона"
		И в поле с именем 'ШаблонОповещения' я ввожу текст "Оповещение после перехода по выбору 2"
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна "* (Этап универсального процесса)*" в течение 20 секунд

	* Этап "Переход по условию" 1
		И в табличном документе 'ТабличноеПолеВозможныхЭтапов' я перехожу к ячейке 'УсловныйПереход'
		И я нажимаю на кнопку с именем 'ДобавитьВыбранныйЭтап'
		Тогда открылось окно "Переход по условию (Этап универсального процесса)"
		И в поле с именем 'Наименование' я ввожу текст "Переход 1"
		И я нажимаю на кнопку с именем 'ТабличноеПолеПереходаДобавитьУсловие'
		И в таблице 'ДеревоОтборов' я разворачиваю строку:
			| "Элемент"            |
			| "Реквизиты процесса" |
		...
		И в таблице 'ТабличноеПолеПерехода' в поле с именем 'ТабличноеПолеПереходаЗначениеОтбора' я ввожу текст "643"
		И в таблице 'ТабличноеПолеПерехода' я завершаю редактирование строки
		Когда открылось окно "Переход по условию (Этап универсального процесса) *"
		И в таблице 'ТабличноеПолеПерехода' я перехожу к строке:
			| "Действие" |
		...
		И в таблице 'ТабличноеПолеПерехода' я активизирую поле с именем 'ТабличноеПолеПереходаЗначение'
		И в таблице 'ТабличноеПолеПерехода' я выбираю текущую строку
		И Я в списке "Этапы универсальных процессов" по полю "Наименование" ищу элемент "Этап 1" "По точному совпадению"
		И в таблице 'Список' количество строк 'равно' 1
		И в таблице 'Список' я выбираю текущую строку
		Тогда открылось окно "Переход по условию (Этап универсального процесса) *"
		И в таблице 'ТабличноеПолеПерехода' я завершаю редактирование строки
		...
		И в таблице 'ТабличноеПолеПерехода' я активизирую поле с именем 'ТабличноеПолеПереходаЗначение'
		И в таблице 'ТабличноеПолеПерехода' я выбираю текущую строку
		И Я в списке "Этапы универсальных процессов" по полю "Наименование" ищу элемент "Авто 1" "По точному совпадению"
		И в таблице 'Список' количество строк 'равно' 1
		И в таблице 'Список' я выбираю текущую строку
		Тогда открылось окно "Переход по условию (Этап универсального процесса) *"
		И в таблице 'ТабличноеПолеПерехода' я завершаю редактирование строки
		...
		Тогда открылось окно "Переход по условию (Этап универсального процесса)"
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна "Переход 1 (Этап универсального процесса)" в течение 20 секунд

	* Этап "Переход по условию" 2
		И в табличном документе 'ТабличноеПолеВозможныхЭтапов' я перехожу к ячейке 'УсловныйПереход'
		И я нажимаю на кнопку с именем 'ДобавитьВыбранныйЭтап'
		Тогда открылось окно "Переход по условию (Этап универсального процесса)"
		И в поле с именем 'Наименование' я ввожу текст "Переход 2"
		И я нажимаю на кнопку с именем 'ТабличноеПолеПереходаДобавитьУсловие'
		И в таблице 'ДеревоОтборов' я разворачиваю строку:
			| "Элемент"            |
			| "Реквизиты процесса" |
		...
		И в таблице 'ТабличноеПолеПерехода' я активизирую поле с именем 'ТабличноеПолеПереходаЗначениеОтбора'
		И в таблице 'ТабличноеПолеПерехода' я нажимаю кнопку выбора у реквизита с именем 'ТабличноеПолеПереходаЗначениеОтбора'
		И Я в списке "Сценарии" по полю "Наименование" ищу и выбираю элемент "ВА - Основной сценарий" "По точному совпадению"
		И в таблице 'ТабличноеПолеПерехода' я завершаю редактирование строки
		Когда открылось окно "Переход по условию (Этап универсального процесса) *"
		И в таблице 'ТабличноеПолеПерехода' я перехожу к строке:
			| "Действие" |
		...
		И в таблице 'ТабличноеПолеПерехода' я активизирую поле с именем 'ТабличноеПолеПереходаЗначение'
		И в таблице 'ТабличноеПолеПерехода' я выбираю текущую строку
		И Я в списке "Этапы универсальных процессов" по полю "Наименование" ищу элемент "Этап 2" "По точному совпадению"
		И в таблице 'Список' количество строк 'равно' 1
		И в таблице 'Список' я выбираю текущую строку
		Тогда открылось окно "Переход по условию (Этап универсального процесса) *"
		И в таблице 'ТабличноеПолеПерехода' я завершаю редактирование строки
		...
		Тогда открылось окно "Переход по условию (Этап универсального процесса)"
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна "Переход 2 (Этап универсального процесса)" в течение 20 секунд
	...
	* Связи этапов
		...
		И в таблице 'ПараметрыПроцесса' я активизирую поле с именем 'ПараметрыПроцессаЗначениеПоУмолчанию'
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна "ВА - Переход по выбору (Шаблон универсального процесса)" в течение 20 секунд
...
Сценарий: 20.12 Настройка матрицы полномочий и списка для "Венера ООО"
	...
	* Удаляем существующие записи по организации "Венера ООО"
		И в таблице 'РегистрПолномочий' я нажимаю на кнопку с именем 'РегистрПолномочийНастройкаСписка'	
		Тогда открылось окно "Настройка списка"
		И я удаляю все строки таблицы 'КомпоновщикНастроекПользовательскиеНастройкиЭлемент0Отбор'
		И в таблице 'КомпоновщикНастроекПользовательскиеНастройкиЭлемент0Отбор' я нажимаю на кнопку с именем 'КомпоновщикНастроекПользовательскиеНастройкиЭлемент0ОтборДобавитьЭлементОтбора'
		...
		И в таблице 'КомпоновщикНастроекПользовательскиеНастройкиЭлемент0Отбор' из выпадающего списка с именем 'КомпоновщикНастроекПользовательскиеНастройкиЭлемент0ОтборПравоеЗначение' я выбираю по строке "Венера ООО"
		И я нажимаю на кнопку с именем 'ФормаЗакончитьРедактирование'
	...
	* Создаем запись матрицы для "Венера ООО"
		И в таблице 'РегистрПолномочий' я нажимаю на кнопку с именем 'РегистрПолномочийСоздать'
		Тогда открылось окно "Регистр матрицы полномочий (создание)"
		И я нажимаю кнопку выбора у поля с именем 'ШаблонДокументаБД'
		Тогда открылось окно "Выбор типа данных"
		...
		И в таблице "" я перехожу к строке:
			...
			| "Шаблон универсального процесса" |
		И в таблице "" я выбираю текущую строку
		И Я в списке "Шаблоны универсальных процессов" по полю "Наименование" ищу и выбираю элемент "ВА - Переход по выбору" "По точному совпадению"
	...
	* Сохраним настройку списка экземпляров
		И В командном интерфейсе я выбираю "Бюджетирование, отчетность и анализ" "Экземпляры отчетов"
		Тогда открылось окно "Экземпляры отчетов"
		Тогда я устанавливаю флаг с именем 'ОтображатьСтандартныеОтборы'
		И в таблице 'Отбор' я нажимаю на кнопку с именем 'ОтборСнятьФлажки'
		...
		Когда открылось окно "Экземпляры отчетов"
		И я нажимаю на кнопку с именем 'СохранитьНастройкуКак'	
		И Я в списке "Сохраненные настройки" по полю "Наименование" ищу элемент "ВА - Согласование - Венера ООО" "По точному совпадению"
		И Пока в таблице 'Список' количество строк 'больше' 0 Тогда
			И Я запоминаю значение выражения '"Удалить_" + СтрЗаменить(Новый УникальныйИдентификатор, "-", "")' в переменную 'УИД'
			И я выбираю пункт контекстного меню с именем 'СписокКонтекстноеМенюИзменить' на элементе формы с именем 'Список'
			Тогда открылось окно "ВА - Согласование - Венера ООО (Вариант настройки)"
			И в поле с именем 'Наименование' я ввожу значение переменной 'УИД'
			И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
			И я жду закрытия окна "ВА - Согласование - Венера ООО *" в течение 20 секунд
			
	Тогда открылось окно "Сохраненные настройки"
	И в поле с именем 'Наименование' я ввожу текст "ВА - Согласование - Венера ООО"
	И я нажимаю на кнопку с именем 'ФормаСохранитьВариант'
	...
	* Настраиваем пользователей
		Когда открылось окно "ВА - Согласование - Венера ООО (Вариант настройки)"
		И в таблице 'Пользователи' я нажимаю на кнопку с именем 'ПользователиДобавить'
		И в таблице 'Пользователи' я нажимаю кнопку выбора у реквизита с именем 'ПользователиПользователь'
		Тогда открылось окно "Выбор типа данных"
		И в таблице "" я перехожу к строке:
		...
		Тогда открылось окно "ВА - Согласование - Венера ООО (Вариант настройки) *"
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна "ВА - Согласование - Венера ООО (Вариант настройки) *" в течение 20 секунд
...
Сценарий: 20.15 Создание шаблона процесса "ВА - Вложенный процесс"
	...
	* Удаляем существующие шаблоны
		И В командном интерфейсе я выбираю "Процессы и согласование" "Шаблоны процессов"
		Тогда открылось окно "Шаблоны универсальных процессов"
		И Я в списке "Шаблоны универсальных процессов" по полю "Наименование" ищу элемент "ВА - Вложенный процесс" "По точному совпадению"
		И пока в таблице 'Список' количество строк ">" 0 Тогда
			И в таблице 'Список' я выбираю текущую строку
			Тогда открылось окно "Редактирование этапов процесса: ВА - Вложенный процесс"
			И я нажимаю на кнопку с именем 'ФормаОткрытьСвойстваПроцесса'
			Тогда открылось окно "ВА - Вложенный процесс (Шаблон универсального процесса)"
			И Я запоминаю значение выражения '"ВА - (удалить) " + StrReplace(Новый УникальныйИдентификатор, "-", "")' в переменную 'UID_Description'
			И в поле с именем 'Наименование' я ввожу значение переменной 'UID_Description'
			И я нажимаю на кнопку с именем 'ФормаЗаписать'
			Тогда открылось окно "$UID_Description$ (Шаблон универсального процесса)"
			...
			И я жду закрытия окна "$UID_Description$ (Шаблон универсального процесса)" в течение 20 секунд
			Тогда открылось окно "Редактирование этапов процесса: ВА - Вложенный процесс"
			И Я закрываю окно "Редактирование этапов процесса: ВА - Вложенный процесс"

	* Создаем шаблон
		Тогда открылось окно "Шаблоны универсальных процессов"
		И я нажимаю на кнопку с именем 'ФормаСоздать'
		Тогда открылось окно "Шаблон универсального процесса (создание)"
		И в поле с именем 'Наименование' я ввожу текст "ВА - Вложенный процесс"
		И из выпадающего списка с именем 'Родитель' я выбираю по строке "ВА - Группа процесса согласования"
		И из выпадающего списка с именем 'НазначениеПроцесса' я выбираю точное значение "Маршрут согласования"
		И из выпадающего списка с именем 'ИмяСправочника' я выбираю точное значение "Документ текущей ИБ"
		И я нажимаю кнопку выбора у поля с именем 'ТипОбъектаСогласования'
	...
	* Этап "Объект утвержден"
		...
		И я нажимаю на кнопку с именем 'ДобавитьВыбранныйЭтап'
		Тогда открылось окно "Автоматическое утверждение документа (Этап универсального процесса)"
		И в поле с именем 'Наименование' я ввожу текст "Авто (влож)"
	...
	* Этап "Переход по условию" 1
		...
		И в таблице 'ТабличноеПолеПерехода' я активизирую поле с именем 'ТабличноеПолеПереходаЗначение'
		И в таблице 'ТабличноеПолеПерехода' я выбираю текущую строку
		И Я в списке "Этапы универсальных процессов" по полю "Наименование" ищу элемент "Этап 1.1" "По точному совпадению"
		И в таблице 'Список' количество строк 'равно' 1
		И в таблице 'Список' я выбираю текущую строку
		Тогда открылось окно "Переход по условию (Этап универсального процесса) *"
		И в таблице 'ТабличноеПолеПерехода' я завершаю редактирование строки
		...
		И в таблице 'ТабличноеПолеПерехода' я активизирую поле с именем 'ТабличноеПолеПереходаЗначение'
		И в таблице 'ТабличноеПолеПерехода' я выбираю текущую строку
		И Я в списке "Этапы универсальных процессов" по полю "Наименование" ищу элемент "Авто (влож)" "По точному совпадению"
		И в таблице 'Список' количество строк 'равно' 1
		И в таблице 'Список' я выбираю текущую строку
		Тогда открылось окно "Переход по условию (Этап универсального процесса) *"
		И в таблице 'ТабличноеПолеПерехода' я завершаю редактирование строки
	...
	* Этап "Переход по условию" 2
		...
		И в таблице 'ТабличноеПолеПерехода' я активизирую поле с именем 'ТабличноеПолеПереходаЗначение'
		И в таблице 'ТабличноеПолеПерехода' я выбираю текущую строку
		И Я в списке "Этапы универсальных процессов" по полю "Наименование" ищу элемент "Этап 1.2" "По точному совпадению"
		И в таблице 'Список' количество строк 'равно' 1
		И в таблице 'Список' я выбираю текущую строку
		Тогда открылось окно "Переход по условию (Этап универсального процесса) *"
		И в таблице 'ТабличноеПолеПерехода' я завершаю редактирование строки
	...
	* Связи этапов
		...
		И в таблице 'ПараметрыПроцесса' я активизирую поле с именем 'ПараметрыПроцессаЗначениеПоУмолчанию'
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна "ВА - Вложенный процесс (Шаблон универсального процесса)" в течение 20 секунд
...
Сценарий: 20.16 Создание шаблона процесса "ВА - Маршрут с вложением"
	...
	* Удаляем существующие шаблоны
		И В командном интерфейсе я выбираю "Процессы и согласование" "Шаблоны процессов"
		Тогда открылось окно "Шаблоны универсальных процессов"
		И Я в списке "Шаблоны универсальных процессов" по полю "Наименование" ищу элемент "ВА - Маршрут с вложением" "По точному совпадению"
		И пока в таблице 'Список' количество строк ">" 0 Тогда
			И в таблице 'Список' я выбираю текущую строку
			Тогда открылось окно "Редактирование этапов процесса: ВА - Маршрут с вложением"
			И я нажимаю на кнопку с именем 'ФормаОткрытьСвойстваПроцесса'
			Тогда открылось окно "ВА - Маршрут с вложением (Шаблон универсального процесса)"
			И Я запоминаю значение выражения '"ВА - (удалить) " + StrReplace(Новый УникальныйИдентификатор, "-", "")' в переменную 'UID_Description'
			И в поле с именем 'Наименование' я ввожу значение переменной 'UID_Description'
			И я нажимаю на кнопку с именем 'ФормаЗаписать'
			Тогда открылось окно "$UID_Description$ (Шаблон универсального процесса)"
			...
			И я жду закрытия окна "$UID_Description$ (Шаблон универсального процесса)" в течение 20 секунд
			Тогда открылось окно "Редактирование этапов процесса: ВА - Маршрут с вложением"
			И Я закрываю окно "Редактирование этапов процесса: ВА - Маршрут с вложением"

	* Создаем шаблон
		Тогда открылось окно "Шаблоны универсальных процессов"
		И я нажимаю на кнопку с именем 'ФормаСоздать'
		Тогда открылось окно "Шаблон универсального процесса (создание)"
		И в поле с именем 'Наименование' я ввожу текст "ВА - Маршрут с вложением"
		И из выпадающего списка с именем 'Родитель' я выбираю по строке "ВА - Группа процесса согласования"
		И из выпадающего списка с именем 'НазначениеПроцесса' я выбираю точное значение "Маршрут согласования"
		И из выпадающего списка с именем 'ИмяСправочника' я выбираю точное значение "Документ текущей ИБ"
		И я нажимаю кнопку выбора у поля с именем 'ТипОбъектаСогласования'
	...
	* Этап "Вложенный процесс"
		...
		И в поле с именем 'Наименование' я ввожу текст "Вложенный процесс"
		И я нажимаю кнопку выбора у поля с именем 'ДочернийМаршрут'
		И Я в списке "Шаблоны универсальных процессов" по полю "Наименование" ищу и выбираю элемент "ВА - Вложенный процесс" "По точному совпадению"
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна "* (Этап универсального процесса)*" в течение 20 секунд
	...
	* Связи этапов
		...
		И в таблице 'ПараметрыПроцесса' я активизирую поле с именем 'ПараметрыПроцессаЗначениеПоУмолчанию'
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна "ВА - Маршрут с вложением (Шаблон универсального процесса)" в течение 20 секунд
...
Сценарий: 20.17 Настройка матрицы полномочий и списка для "Марс ООО"
	...
	* Удаляем существующие записи по организации "Марс ООО"
		И в таблице 'РегистрПолномочий' я нажимаю на кнопку с именем 'РегистрПолномочийНастройкаСписка'	
		Тогда открылось окно "Настройка списка"
		И я удаляю все строки таблицы 'КомпоновщикНастроекПользовательскиеНастройкиЭлемент0Отбор'
		И в таблице 'КомпоновщикНастроекПользовательскиеНастройкиЭлемент0Отбор' я нажимаю на кнопку с именем 'КомпоновщикНастроекПользовательскиеНастройкиЭлемент0ОтборДобавитьЭлементОтбора'
		...
		И в таблице 'КомпоновщикНастроекПользовательскиеНастройкиЭлемент0Отбор' из выпадающего списка с именем 'КомпоновщикНастроекПользовательскиеНастройкиЭлемент0ОтборВидСравнения' я выбираю точное значение "Равно"
		И в таблице 'КомпоновщикНастроекПользовательскиеНастройкиЭлемент0Отбор' я активизирую поле с именем 'КомпоновщикНастроекПользовательскиеНастройкиЭлемент0ОтборПравоеЗначение'
		И в таблице 'КомпоновщикНастроекПользовательскиеНастройкиЭлемент0Отбор' из выпадающего списка с именем 'КомпоновщикНастроекПользовательскиеНастройкиЭлемент0ОтборПравоеЗначение' я выбираю по строке "Марс ООО"
		И я нажимаю на кнопку с именем 'ФормаЗакончитьРедактирование'
	...
	* Создаем запись матрицы для "Марс ООО"
		И в таблице 'РегистрПолномочий' я нажимаю на кнопку с именем 'РегистрПолномочийСоздать'
		Тогда открылось окно "Регистр матрицы полномочий (создание)"
		И я нажимаю кнопку выбора у поля с именем 'ШаблонДокументаБД'
		Тогда открылось окно "Выбор типа данных"
		...
		Тогда открылось окно "Регистр матрицы полномочий (создание) *"
		И я нажимаю кнопку выбора у поля с именем 'Организация'
		И Я выбираю организацию "Марс ООО"
		...
		И в таблице "" я перехожу к строке:
			...
			| "Шаблон универсального процесса" |
		И в таблице "" я выбираю текущую строку
		И Я в списке "Шаблоны универсальных процессов" по полю "Наименование" ищу и выбираю элемент "ВА - Маршрут с вложением" "По точному совпадению"
	...
	* Сохраним настройку списка экземпляров
		...
		И в таблице 'Отбор' я перехожу к строке:
			| "Вид сравнения" | "Использование" | "ПОЛЕ"        | "Режим отображения" |
			| "Равно"         | "Нет"           | "Организация" | "Быстрый доступ"    |
		И в таблице 'Отбор' из выпадающего списка с именем 'ОтборПравоеЗначение' я выбираю по строке "Марс ООО"
		...
		Когда открылось окно "Экземпляры отчетов"
		И я нажимаю на кнопку с именем 'СохранитьНастройкуКак'	
		И Я в списке "Сохраненные настройки" по полю "Наименование" ищу элемент "ВА - Согласование - Марс ООО" "По точному совпадению"
		И Пока в таблице 'Список' количество строк 'больше' 0 Тогда
			И Я запоминаю значение выражения '"Удалить_" + СтрЗаменить(Новый УникальныйИдентификатор, "-", "")' в переменную 'УИД'
			И я выбираю пункт контекстного меню с именем 'СписокКонтекстноеМенюИзменить' на элементе формы с именем 'Список'
			Тогда открылось окно "ВА - Согласование - Марс ООО (Вариант настройки)"
			И в поле с именем 'Наименование' я ввожу значение переменной 'УИД'
			И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
			И я жду закрытия окна "ВА - Согласование - Марс ООО *" в течение 20 секунд
			
	Тогда открылось окно "Сохраненные настройки"
	И в поле с именем 'Наименование' я ввожу текст "ВА - Согласование - Марс ООО"
	И я нажимаю на кнопку с именем 'ФормаСохранитьВариант'
	...
	* Настраиваем пользователей
		Когда открылось окно "ВА - Согласование - Марс ООО (Вариант настройки)"
		И в таблице 'Пользователи' я нажимаю на кнопку с именем 'ПользователиДобавить'
		И в таблице 'Пользователи' я нажимаю кнопку выбора у реквизита с именем 'ПользователиПользователь'
		Тогда открылось окно "Выбор типа данных"
		И в таблице "" я перехожу к строке:
		...
		Тогда открылось окно "ВА - Согласование - Марс ООО (Вариант настройки) *"
		И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
		И я жду закрытия окна "ВА - Согласование - Марс ООО (Вариант настройки) *" в течение 20 секунд
