...
Сценарий: 07.08 Интерактивное удаление показателей
	...
	* Сверяем результат
		Тогда табличный документ 'ПолеТабличногоДокументаМакет' равен:
			...
			| ''                                      | "Январь 2024 г." | ''                | ''               | ''        | "Февраль 2024 г." | ''                | ''               | ''        | "Март 2024 г." | ''                | ''               | ''        | "ИТОГО"     | ''                | ''               | ''        |
			| ''                                      | "Цена"           | "ДатаПоступления" | "ВключатьВПрайс" | "Артикул" | "Цена"            | "ДатаПоступления" | "ВключатьВПрайс" | "Артикул" | "Цена"         | "ДатаПоступления" | "ВключатьВПрайс" | "Артикул" | "Цена"      | "ДатаПоступления" | "ВключатьВПрайс" | "Артикул" |
			| "Товары"                                | '1 950 000'      | ''                | "Нет"            | ''        | '1 686 667'       | '02.01.2024'      | "Нет"            | ''        | '1 686 667'    | '02.01.2024'      | "Нет"            | ''        | '1 724 286' | '02.01.2024'      | "Нет"            | ''        |
			| "1С:Управление холдингом 8 "            | '0'              | ''                | "Нет"            | ' '       | '2 145 000'       | '02.05.2024'      | "Да"             | '2000005' | '2 145 000'    | '02.05.2024'      | "Да"             | '2000005' | '2 145 000' | '02.05.2024'      | "Нет"            | ''        |
			| "1С:Корпорация "                        | '0'              | ''                | "Нет"            | ''        | '2 255 000'       | ''                | "Нет"            | ''        | '2 255 000'    | ''                | "Нет"            | ''        | '2 255 000' | ''                | "Нет"            | ''        |
			| "1С:ERP. Управление холдингом "         | '1 950 000'      | ''                | "Да"             | '000004'  | '660 000'         | '02.01.2024'      | "Да"             | '2000001' | '660 000'      | '02.01.2024'      | "Да"             | '2000001' | '1 090 000' | '02.01.2024'      | "Нет"            | ''        |
